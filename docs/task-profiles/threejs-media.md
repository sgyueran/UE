# Three.js and media tasks

## Applies To

Tasks declaring `Profile: treejs-media`.

## Shared Quality Rules

- Dynamic import, explicit user-triggered heavy loading, poster fallback, disposal, and graceful unsupported-device behavior.
